      ...
      items: [
        {
          icon: 'monitor',
          title: 'PC / Cloud',
          clients: ['Inventec', 'MiTAC', 'Quanta Computer', 'ECS Elitegroup', 'Gigabyte', 'Shuttle', 'Wistron', 'Pegatron', 'MSI', 'ASUS', 'Compal'],
        },
        {
          icon: 'wifi',
          title: 'IoT',
          clients: ['DFI', 'Protech Systems', 'ADLINK', 'Axiomtek', 'Lanner', 'Portwell', 'Advantech', 'AcBel', 'USI', 'ICP'],
        },
        {
          icon: 'globe',
          title: 'Network',
          clients: ['ZyXEL', 'Gemtek', 'CyberTAN', 'Alpha Networks', 'ASKEY', 'Sercomm', 'Delta', 'Arcadyan', 'Accton'],
        },
      ],
    },
    cta: {
      ...
      vendors: [
        {
          ...
          products: [
            ...
            { name: '固態硬碟', url: 'https://www.teamgroupinc.com/tw/product-category/ssd' },
            { name: '記憶卡', url: 'https://www.teamgroupinc.com/tw/product-category/card' },
            { name: 'USB 隨身碟', url: 'https://www.teamgroupinc.com/tw/product-category/usb' },
          ],
        },
        {
          name: '晶發科技',
          ...
          products: [
            ...
            { name: 'LED Drivers', url: 'https://www.gifarlcm.com' },
            { name: 'Pseudo SRAM', url: 'https://www.gifarlcm.com' },
          ],
        },
        {
          name: '普冉科技',
          ...
          products: [
            ...
            { name: 'SPI NAND FLASH', url: 'https://www.puyasemi.com/flashxinpian.html' },
            { name: 'Parallel NAND Flash', url: 'https://www.puyasemi.com/flashxinpian.html' },
          ],
        },
      ],
    },
      ...
      vendors: [
        {
          ...
          products: [
            ...
            { name: 'SSD', url: 'https://www.teamgroupinc.com/en/product-category/ssd' },
            { name: 'Memory Cards', url: 'https://www.teamgroupinc.com/en/product-category/card' },
            { name: 'USB Drives', url: 'https://www.teamgroupinc.com/en/product-category/usb' },
          ],
        },
        {
